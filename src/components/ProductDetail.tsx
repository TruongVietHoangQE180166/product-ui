import { ArrowLeft, Edit3, Trash2, ShoppingCart } from "lucide-react";
            ...
            <div className="lg:w-1/2 p-6 sm:p-8 lg:p-10">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-4">
                {isLoggedIn && (
                  <>
                    <button
                      ...
                      className="flex-1 bg-amber-500 hover:bg-amber-600 text-white px-4 py-3 rounded-lg flex items-center justify-center space-x-2 transition-all duration-200 shadow-lg hover:shadow-xl hover:scale-[1.02] text-sm sm:text-base font-medium"
                    ...
                    <button
                      ...
                      className="flex-1 bg-red-500 hover:bg-red-600 text-white px-4 py-3 rounded-lg flex items-center justify-center space-x-2 transition-all duration-200 shadow-lg hover:shadow-xl hover:scale-[1.02] text-sm sm:text-base font-medium"
                ...
                <button
                  ...
                  className="flex-1 bg-green-500 hover:bg-green-600 text-white px-4 py-3 rounded-lg flex items-center justify-center space-x-2 transition-all duration-200 shadow-lg hover:shadow-xl hover:scale-[1.02] text-sm sm:text-base font-medium"
              ...
              {/* Nếu chưa login thì hiển thị yêu cầu đăng nhập */}
              {!isLoggedIn && (
